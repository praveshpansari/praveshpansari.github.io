        ...
        <div className={styles.projects}>
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              <br />
              <br />
              An automatic cost optimization platform for AWS services which aimed to reduce 10% of AWS service costs
              for the client. CloudFix scans your AWS accounts, identifies new cost savings opportunities, and
              automatically implements fixes – around the clock. Unlike tools that just find one-off savings, CloudFix
              runs continuously in the background, so you can realize 15-60% per AWS service in compounding savings.
              <br />
              <br />
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              <br />
              <br />
              An e-commerce website aiming to provide products as a wholesale where buying would be done through a
              bidding system. It allows the buyers to bid and buy products in large quantities and sellers to list
              products in bulk quantity and approve buyer bids. It is a platform connecting Gharelubazzar, already a
              leading seller in Nepal, as well as other wholesalers to large retailers as well as small shops.
              <br />
              <br />
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              consultations with the best doctors in all areas of specialty, upload their medical results, and track
              their treatment plan and progress in a 100% secure and confidential way. Bookings can be made to the
              nearest doctors for appointments and consultation.
              <br />
              <br />
              <b>Role: </b>Created the admin panel, developed APIs for features like scheduling appointments, bookings,
              patient reports etc.
              <br />
              <b>Leveraged Technologies: </b>JavaScript, TypeScript, Angular, Node.js, HTML/CSS, SCSS, MongoDB, REST
              APIs
            </div>
          </article>
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              dairy products, bakery items, cosmetics and more. Their mission is to focus on quantity, cost leadership
        ...
        <div className={`${styles.projects} ${styles.personal_projects}`}>
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              recognition of the segmented characters are the processes involved in a number plate recognition system.
              The system then uses Convolutional Neural Network (CNN) for predicting each segmented character. The CNN
              is trained on a 17,400 image dataset made using 30 Nepali characters generated from different computer
              fonts and handwritten characters. The color of the plate is recognized using k-means clustering and
              choosing the nearest centroid color. It is deployed using Flask.
              <br />
              <br />
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              <br />
              <br />
              This is an ecommerce website with three types of users: Buyers, Traders and Admin. Each user has a
              different dashboard and different functions. Buyers can favorite products, add them to cart and buy them
              using PayPal, traders can sell and manage orders and admins can manage users, products and orders. After a
              successful order invoice is also emailed to the customer. There is also a management dashboard build using
              APEX oracle to display daily finance and delivery and monthly sales reports by making use of Oracle
              functions, procedures & triggers are used.
              <br />
              <br />
              <b>Leveraged Technologies: </b> XAMPP, MariaDB, PHP, jQuery, HTML/CSS/JS, Oracle Database, PL/SQL,
              Bootstrap
            </div>
          </article>
          <article className={styles.article}>
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              and delete them. The basic CRUD operations for TODO exists like adding, updating, listing them with
              Recycle view and deleting them. There is a login screen with validation and shared preferences. Users can
              view TODOs in 4 categories of today, tommorow, later & older. All views have landscape layout and all
              update operations have validations.
              <br />
              <br />
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              information. The syntax button analyzes the code in the code editor and displays any errors it found in
              the log box. Four types of shapes can be drawn: rectangle, square, circle and triangle. A line can be
              drawn given a destination position. The shapes can be drawn outlined or filled and their color can be
              changed. Variables can be declared, a while loop is present and both parameterized and parameter less
          ...
          <article className={styles.article}>
            ...
            <div className={styles.works_description}>
              ...
              HTML, CSS & JS. Includes particle.js for reverse snow effect on the hero section, an eye catching theme
              with parallax scroll and beautiful animations. There is a home page, about page, contact page, pricing
